...
stack ghc -- --make -no-hs-main -optc-O -Ic_library/dependencies -Ic_library/src c_library/test/test_tries.c c_library/dependencies/unity.c c_library/src/tries.c src/CTries -o c_library/test/test_tries
